...
function GoogleButton() {
  ...
  return (
    <button
      type="button"
      disabled={loading}
      onClick={() => { setLoading(true); void signIn("google", { callbackUrl: "/dashboard" }); }}
    ...
    >
      ...
      <span className="text-sm font-medium text-gray-700">{loading ? "Redirecting..." : "Continue with Google"}</span>
    </button>
  );
}
